...
namespace Eureka\Middleware\Thumbnail;
 ...
 */
class ThumbnailMiddleware implements ServerMiddlewareInterface
{
    ...
    public function process(ServerRequestInterface $request, DelegateInterface $frame)
    {
        ...
        $response = $this->decomposeUri($request)->assertIsValidThumbnail()->readFile($request, $response);
